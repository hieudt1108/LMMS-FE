...
const DocumentbySyllabus = lazy(() => import('./document/pages/DocumentbySyllabus'));
const DocumentInforDetail = lazy(() => import('./document/components/InforDetail'));
  ...
  return (
    <Routes basename={process.env.PUBLIC_URL}>
      ...
      <PrivateRoute path="admin" element={<Admin />}>
        ...
        <PrivateRoute path="/document/:subjectSlot" element={<DocumentbySyllabus />} />
        <PrivateRoute path="/document/:subjectSlot/1" element={<DocumentInforDetail />} />
