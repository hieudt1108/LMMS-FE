...
import { CardActionArea, CardMedia, CardContent, Typography, IconButton } from '@mui/material';
    ...
    <React.Fragment>
      <Grid item xs={12} sm={6} md={4} lg={3} xl={2}>
        <Card sx={{ maxWidth: 345 }}>
          ...
          >
            <CardMedia component="img" height="145" image="img\portrait-1.jpg" alt="green iguana" />
            <CardContent>
              <Stack
                direction="row"
