...
import {deleteSlot, deleteProgram, getAllSlot} from "../../../dataProvider/agent";
...
export default function SlotListPage() {
    ...
    const handleDeleteRow = async (id) => {
        ...
        if (response.status < 400) {
            setSelected([]);
            await fetchSlots();
            enqueueSnackbar('Xóa tiết học thành công');
        } else {
            enqueueSnackbar('Xóa tiết học thất bại', { variant: 'error' });
        }
            ...
            <Container maxWidth={'xl'}>
                <CustomBreadcrumbs
                    ...
                    links={[
                        ...
                        {name: 'Tiết học', href: PATH_DASHBOARD.slot.root},
                        {name: 'Danh sách'},
                    ]}
                    action={
                            ...
                            <Table size={dense ? 'small' : 'medium'} sx={{minWidth: 800}}>
                                ...
                                <TableBody>
                                    ...
                                    <TableEmptyRows height={denseHeight}
                                                    emptyRows={emptyRows(page, rowsPerPage, listSlots.length)}/>
