...
import {
    ...
    getDocumentById,
    getGradeById,
    getLocalStorage, postDocumentsInSlot,
...
export default function FileGeneralRecentCard({dataGeneralFolder, file, dataUploadDocsToSlot, onDelete, sx, ...other}) {
                    ...
                    <Button
                        ...
                        onClick={() => {
                            if (dataGeneralFolder && dataUploadDocsToSlot == null) {
                                ...
                                handleAddDocumentToSlot(dataUploadDocsToSlot.classId,file.id,dataUploadDocsToSlot.slotId,dataUploadDocsToSlot.subjectId)
                            }
                            handleCloseConfirm();
                        }}
                    >
