...
const ProgramDialog = ({ onAdd, onClose, onUpdate, open, processing, program }: ProgramDialogProps) => {
    ...
    >
      <form onSubmit={formik.handleSubmit} noValidate>
        <DialogTitle id="program-dialog-title">
          {editMode ? t('programManagement.modal.edit.title') : t('programManagement.modal.add.title')}
        </DialogTitle>
        <DialogContent>
          <Box sx={{ flexGrow: 1 }}>
